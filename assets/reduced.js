...
// CONCATENATED MODULE: ./source/scripts/globals/jquery-plugins.js
...
jquery_default.a.fn.ariaHidden = function (toggleOn) {
...
// CONCATENATED MODULE: ./source/scripts/Constants.js
var selectors = {
  header: {
  ...
  product: {
    ...
    slideshowImages: '[data-product-slideshow-viewport]',
    slideshowImage: '[data-product-slideshow-media]',
...
var classes = {
  ...
  product: {
    slideshowImageSelected: 'product-slideshow-media-selected',
    slideshowThumbnailSelected: 'product-slideshow-thumbnail-selected',
...
// CONCATENATED MODULE: ./source/scripts/helpers/Newsletter.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }




var Newsletter_Newsletter = function Newsletter() {
    ...
    value: function _onSectionEvent(event) {
      ...
      switch (event.type) {
        ...
        case 'shopify:section:reorder':
          this._triggerInstanceEvent(instance, 'onSectionReorder', {
            el: el,
            id: sectionId
          });
...
var ScrollLock_ScrollLock = /*#__PURE__*/function () {
  function ScrollLock() {
  ...
  ScrollLock_createClass(ScrollLock, [{
    key: "lock",
    value: function lock() {
...
// CONCATENATED MODULE: ./source/scripts/Modal.js
...
var Modal_Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    this.modal = null;
    this.$modal = jquery_default()(selectors.modal.wrapper);
    this.scrollLock = new ScrollLock_ScrollLock(); // Extend default vanilla-modal callbacks back to instantiator of Modal
  ...
  Modal_createClass(Modal, [{
    ...
    value: function open(selector) {
      ...
      this.modal = new dist_default.a(this.modalOptions);
...
// CONCATENATED MODULE: ./source/scripts/sections/StaticHeaderReduced.js
function StaticHeaderReduced_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function StaticHeaderReduced_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function StaticHeaderReduced_createClass(Constructor, protoProps, staticProps) { if (protoProps) StaticHeaderReduced_defineProperties(Constructor.prototype, protoProps); if (staticProps) StaticHeaderReduced_defineProperties(Constructor, staticProps); return Constructor; }





var StaticHeaderReduced_StaticHeaderReduced = /*#__PURE__*/function () {
  function StaticHeaderReduced(section) {
    StaticHeaderReduced_classCallCheck(this, StaticHeaderReduced);
  ...
  StaticHeaderReduced_createClass(StaticHeaderReduced, [{
    key: "onSectionUnload",
    ...
    value: function _onModalClose() {
      jquery_default()(this.passwordTrigger).focus();
    }
  }, {
    key: "_onModalOpen",
...
var StaticGiftCard_StaticGiftCard = /*#__PURE__*/function () {
  function StaticGiftCard(section) {
    ...
    script_default()($scripts.data('shopify-qrcode'), function () {
...
// CONCATENATED MODULE: ./source/scripts/reduced.js
// jQuery plugins
...
sections.register('static-header-reduced', function (section) {
  return new StaticHeaderReduced_StaticHeaderReduced(section);
});
sections.register('static-gift-card', function (section) {
  return new StaticGiftCard_StaticGiftCard(section);
});
new Newsletter_Newsletter();

/***/ })
/******/ ]);
//# sourceMappingURL=reduced.js.map?1587071216925